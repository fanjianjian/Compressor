...
public class Compressor {
    ...
    private static String DEFAULT_DISK_CACHE_DIR = "compressor_disk_cache";
    ...
    public static Compressor get(Context context) {
        if (INSTANCE == null) INSTANCE = new Compressor(context);
        return INSTANCE;
    }

    public Compressor load(File file) {
        mFile = file;
        return this;
    }
    ...
    public Compressor startAsync(OnCompressListener listener) {
        ...
        asyncTask = new AsyncTask<File, Void, File>() {
            @Override
            ...
            protected void onPostExecute(File file) {
                ...
                if (file == null) {
                    if (compressListener != null) compressListener.onError(new Throwable("压缩失败"));
                } else {
